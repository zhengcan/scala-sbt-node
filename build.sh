...
docker push     zhengcan/scala-sbt-node:11-base-node12
docker push     zhengcan/scala-sbt-node:11-base-node10
docker push     zhengcan/scala-sbt-node:11-base
docker push     zhengcan/scala-sbt-node:8-base-node12
docker push     zhengcan/scala-sbt-node:8-base-node10
docker push     zhengcan/scala-sbt-node:8-base
...
docker push     zhengcan/scala-sbt-node:11-node12
docker push     zhengcan/scala-sbt-node:11-node10
docker push     zhengcan/scala-sbt-node:11
docker push     zhengcan/scala-sbt-node:8-node12
docker push     zhengcan/scala-sbt-node:8-node10
docker push     zhengcan/scala-sbt-node:8
docker push     zhengcan/scala-sbt-node:latest
...
docker push     zhengcan/scala-sbt-node:11-expo
docker push     zhengcan/scala-sbt-node:8-expo
